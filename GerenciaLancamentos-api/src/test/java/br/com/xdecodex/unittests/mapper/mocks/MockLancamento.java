...
public class MockLancamento {
    ...
    public Lancamento mockEntity(Integer number) {
        ...
        lancamento.setDataPagamento(LocalDate.now().plusDays(number));// Definindo DataVencimento corretamente
    ...
    public LancamentoVO mockVO(Integer number) {
        ...
        lancamentoVO.setDataPagamento(LocalDate.now().plusDays(number));// Definindo DataVencimento corretamente
