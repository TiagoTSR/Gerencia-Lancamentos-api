...
public class LaunchController {
    ...
    @Operation(summary = "Find all launches", description = "Find all launches",
		tags = {"Launch"},
		responses = {
			@ApiResponse(description = "Success", responseCode = "200",
				...
				@Content(
					...
					array = @ArraySchema(schema = @Schema(implementation = LaunchVO.class))
				)
			}),
    ...
    public ResponseEntity<List<LaunchVO>> findAll(LaunchFilter launchFilter) {
        List<LaunchVO> launchs = launchService.filtrar(launchFilter);
    ...
    @Operation(summary = "Find a launch", description = "Find a launch",
	tags = {"Launch"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200",
			content = @Content(schema = @Schema(implementation = LaunchVO.class))
		),
	...
	description = "Adds a new release by passing a JSON, XML or YML representation of the release!",
	tags = {"Launch"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200",
			content = @Content(schema = @Schema(implementation = LaunchVO.class))
	...
	description = "Updates a release by passing a JSON, XML or YML representation of the release!",
	tags = {"Launch"},
	responses = {
    ...
    @Operation(summary = "Deletes a release",
	description = "Deletes a release by passing a JSON, XML or YML representation of the release!",
	tags = {"Launch"},
	responses = {
		@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
		@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
